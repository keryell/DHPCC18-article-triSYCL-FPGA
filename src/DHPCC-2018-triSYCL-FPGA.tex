...
(the code from Figure~\ref{fig:SYCL-dataflow}) and without these
optimizations in SYCL, but also with non-single source HLS C++ or OpenCL C
kernels, coming from \cite{Xilinx:GitHub:SDAccel_Examples}. The SYCL
examples have been translated for this study from the HLS C++ and OpenCL
examples, leading to quite shorter examples, typically less than 100 lines
...
\begin{figure}
  ...
  \caption{Comparison of execution times of 2D array transfers with
    various tools and languages with Xilinx FPGA acceleration card.}
...
\begin{figure}
  ...
  \caption{Comparison of execution times of matrix multiplication various
    tools and languages with Xilinx FPGA acceleration card.}
